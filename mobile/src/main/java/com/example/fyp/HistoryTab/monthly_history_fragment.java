...
public class monthly_history_fragment extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        daymonth01 =String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth02 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth03 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth04 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth05 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth06 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth07 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth08 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth09 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth10 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth11 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth12 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth13 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth14 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth15 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth16 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth17 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth18 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth19 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth20 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth21 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth22 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth23 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth24 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth25 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth26 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth27 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        daymonth28 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
        dayOfMonth = dayOfMonth+1;
        if ( dayOfMonth != maxday) {
            daymonth29 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
            dayOfMonth = dayOfMonth + 1;
            if ( dayOfMonth != maxday) {
                daymonth30 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
                dayOfMonth = dayOfMonth + 1;
                if ( dayOfMonth != maxday) {
                    daymonth31 = String.format("%02d", dayOfMonth) + String.format("%02d", month) + year;
                }
                else { daymonth31 = "0";}
            }
            else { daymonth30 = "0";}
